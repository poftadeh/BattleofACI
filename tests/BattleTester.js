...
class BattleTester {
    constructor() {
        ...
        this.dealer.dealSpecificCardToPlayer(this.players[0], new Card("scarecrow"))
        this.dealer.dealSpecificCardToPlayer(this.players[1], new Card("mercenary", 6, false))
        this.dealer.dealSpecificCardToPlayer(this.players[1], new Card("mercenary", 6, false))
        ...
        this.dealer.dealSpecificCardToPlayer(this.players[1], new Card("spring"))
        this.battle.turn(this.players[0], "play", "mercenary", 10)
        this.battle.turn(this.players[0], "play", "scarecrow", 0, "mercenary", 10)
        //this.battle.turn(this.players[0], "play", "mercenary", 10)
        // this.battle.turn(this.players[1], "play", "mercenary", 6)
        // this.battle.turn(this.players[1], "play", "mercenary", 6)
        // this.battle.turn(this.players[1], "play", "spring")
        // this.battle.turn(this.players[0], "play", "winter");
        // this.battle.turn(this.players[0], "play", "bishop");
        // this.battle.turn(this.players[1], "play", "bishop", 10)
